...
if (!isMainModule({
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		import("./run-main-hdIjkPKi.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
...
//#endregion
export { isSelfChatMode as $, clearInternalHooks as $t, normalizeChannelId as A, getResolvedLoggerSettings as At, getPluginCommandSpecs as B, isNixMode as Bt, CHANNEL_IDS as C, success as Ct, getChatChannelMeta as D, theme as Dt, formatChannelSelectionLine as E, isRich as Et, createEmptyPluginRegistry as F, tryParseLogLevel as Ft, clampInt as G, resolveGatewayLockDir as Gt, matchPluginCommand as H, resolveConfigPath as Ht, createPluginRegistry as I, resolvePreferredOpenClawTmpDir as It, displayString as J, resolveLegacyStateDirs as Jt, clampNumber as K, resolveGatewayPort as Kt, normalizePluginHttpPath as L, CONFIG_PATH as Lt, getActivePluginRegistry as M, resolveNodeRequireFromMeta as Mt, requireActivePluginRegistry as N, ALLOWED_LOG_LEVELS as Nt, listChatChannels as O, getChildLogger as Ot, setActivePluginRegistry as P, normalizeLogLevel as Pt, isRecord as Q, resolveStateDir as Qt, clearPluginCommands as R, DEFAULT_GATEWAY_PORT as Rt, unregisterActiveProgressLine as S, shouldLogVerbose as St, formatChannelPrimerLine as T, colorize as Tt, CONFIG_DIR as U, resolveConfigPathCandidate as Ut, listPluginCommands as V, resolveCanonicalConfigPath as Vt, clamp as W, resolveDefaultConfigCandidates as Wt, escapeRegExp as X, resolveOAuthDir as Xt, ensureDir as Y, resolveNewStateDir as Yt, formatTerminalLink as Z, resolveOAuthPath as Zt, createNonExitingRuntime as _, isVerbose as _t, normalizeEnv as a, getCommandPath as an, resolveJidToE164 as at, clearActiveProgressLine as b, logVerboseConsole as bt, runtimeForLogger as c, getPrimaryCommand as cn, shortenHomeInString as ct, setConsoleSubsystemFilter as d, hasHelpOrVersion as dn, sliceUtf16Safe as dt, createInternalHookEvent as en, jidToE164 as et, setConsoleTimestampPrefix as f, hasRootVersionAlias as fn, toWhatsappJid as ft, visibleWidth as g, resolveRequiredHomeDir as gn, info as gt, stripAnsi as h, expandHomePrefix as hn, danger as ht, logAcceptedEnvOption as i, buildParseArgv as in, resolveHomeDir as it, normalizeChatChannelId as j, toPinoLikeLogger as jt, normalizeAnyChannelId as k, getLogger as kt, enableConsoleCapture as l, getVerboseFlag as ln, shortenHomePath as lt, formatLocalIsoWithOffset as m, normalizeProfileName as mn, isPlainObject as mt, isMainModule as n, triggerInternalHook as nn, pathExists as nt, parseBooleanValue as o, getFlagValue as on, resolveUserPath as ot, shouldLogSubsystemToConsole as p, shouldMigrateStateFromPath as pn, truncateUtf16Safe as pt, displayPath as q, resolveIsNixMode as qt, isTruthyEnvValue as r, normalizeWindowsArgv as rn, resolveConfigDir as rt, createSubsystemLogger as s, getPositiveIntFlagValue as sn, safeParseJson as st, installProcessWarningFilter as t, registerInternalHook as tn, normalizeE164 as tt, routeLogsToStderr as u, hasFlag as un, sleep as ut, defaultRuntime as v, isYes as vt, CHAT_CHANNEL_ORDER as w, warn as wt, registerActiveProgressLine as x, setVerbose as xt, restoreTerminalState as y, logVerbose as yt, executePluginCommand as z, STATE_DIR as zt };