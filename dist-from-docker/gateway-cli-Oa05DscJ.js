import { $t as clearInternalHooks, At as getResolvedLoggerSettings, Bt as isNixMode, C as CHANNEL_IDS, Dt as theme, Et as isRich, F as createEmptyPluginRegistry, Gt as resolveGatewayLockDir, Ht as resolveConfigPath, Kt as resolveGatewayPort, Lt as CONFIG_PATH, M as getActivePluginRegistry, Ot as getChildLogger, Qt as resolveStateDir, Tt as colorize, W as clamp, Y as ensureDir, c as runtimeForLogger, d as setConsoleSubsystemFilter, en as createInternalHookEvent, f as setConsoleTimestampPrefix, i as logAcceptedEnvOption, kt as getLogger, lt as shortenHomePath, mt as isPlainObject, nn as triggerInternalHook, ot as resolveUserPath, pt as truncateUtf16Safe, r as isTruthyEnvValue, s as createSubsystemLogger, tn as registerInternalHook, v as defaultRuntime, xt as setVerbose, zt as STATE_DIR } from "./entry.js";
...
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-BWoB6KB9.js";
import { C as isSubagentSessionKey, c as normalizeMainKey, f as toAgentRequestSessionKey, h as normalizeAccountId, l as resolveAgentIdFromSessionKey, m as DEFAULT_ACCOUNT_ID, o as classifySessionKeyShape, p as toAgentStoreSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, w as parseAgentSessionKey, x as isCronRunSessionKey } from "./session-key-DIABCrXz.js";
import { r as matchesSkillFilter, t as resolveOpenClawPackageRoot } from "./openclaw-root-BWKDUbl-.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-G9-WTRVN.js";
...
import { d as hasBinary } from "./frontmatter-17nP3KZr.js";
import { r as isPathInsideWithRealpath } from "./scan-paths-DkMlwCU-.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-CWeJXlIQ.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-BPlNBgie.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BN0uSo-W.js";
import { A as isAvatarImageDataUrl, At as resolveAgentMaxConcurrent, D as AVATAR_MAX_BYTES, E as parseByteSize, Ot as buildTalkConfigResponse, P as looksLikeAvatarPath, T as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, i as loadConfig, jt as resolveSubagentMaxConcurrent, k as isAvatarHttpUrl, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, vt as applyMergePatch, yt as applyLegacyMigrations } from "./config-LXNfmZdV.js";
import { i as resolveRuntimeServiceVersion, r as VERSION } from "./env-vars-iFkEK4MO.js";
...
import { $ as resolveExplicitAgentSessionKey, A as readSessionMessages, B as cleanStaleLockFiles, D as archiveSessionTranscripts, E as archiveFileOnDisk, F as stripEnvelopeFromMessages, G as resolveSessionResetPolicy, L as stripInlineDirectiveTagsForDisplay, N as resolveSessionTranscriptCandidates, O as capArrayByJsonBytes, P as stripEnvelopeFromMessage, Q as resolveAgentMainSessionKey, R as stripInlineDirectiveTagsFromMessageForDisplay, S as mergeDeliveryContext, U as evaluateSessionFreshness, X as setSessionRuntimeModel, Z as canonicalizeMainSessionAlias, b as deliveryContextFromSession, c as loadSessionStore, et as resolveMainSessionKey, h as updateSessionStore, j as readSessionPreviewItemsFromTranscript, k as cleanupArchivedSessionTranscripts, n as extractDeliveryInfo, r as parseSessionThreadInfo, rt as snapshotSessionOrigin, tt as resolveMainSessionKeyFromConfig, w as normalizeSessionDeliveryFields } from "./sessions-YJLT80__.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-B-4EYGZt.js";
import { i as resolveWhatsAppAccount } from "./accounts-g8UOA9ZQ.js";
import "./accounts-iAP56FFD.js";
import "./accounts-B7WS3ElX.js";
import { t as buildChannelAccountBindings } from "./bindings-CqPOClAk.js";
import "./logging-CFvkxgcX.js";
import "./send-BinN2sn8.js";
import "./send-BCwiIq7z.js";
import { $ as BARE_SESSION_RESET_PROMPT, $n as clearBootstrapSnapshot, $t as applyModelOverrideToSessionEntry, A as createOutboundSendDeps, An as normalizeSendPolicy, At as inferLegacyName, B as buildHistoryContextFromEntries, Bn as resolveAgentTimeoutMs, C as computeBackoff, Dr as getAgentRunContext, Dt as normalizeHttpWebhookUrl, E as agentCommand, Er as emitAgentEvent, Et as writeRestartSentinel, Fn as DEFAULT_INPUT_TIMEOUT_MS, Ft as normalizeRequiredName, Gn as formatZonedTimestamp, Gt as isExternalHookSession, Ht as buildSafeExternalPrompt, In as extractFileContentFromSource, It as migrateLegacyCronPayload, J as dispatchInboundMessage, Jn as isAbortRequestText, Jt as resolveSessionAuthProfileOverride, Kt as applyBrowserProxyPaths, Ln as extractImageContentFromSource, Lt as buildDeliveryFromLegacyPayload, M as createOutboundSendDeps$1, Mn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Mt as normalizeOptionalSessionKey, N as resolveAgentAvatar, Nn as DEFAULT_INPUT_IMAGE_MIMES, Nt as normalizeOptionalText, O as resolveAgentDeliveryPlan, Or as onAgentEvent, Ot as normalizeCronJobCreate, Pn as DEFAULT_INPUT_MAX_REDIRECTS, Pt as normalizePayloadToSystemText, Qn as resolveUserTimezone, Rn as normalizeMimeList, Rt as hasLegacyDeliveryHints, S as requestBodyErrorToText, Sn as isSystemEventContextChanged, St as formatRestartSentinelMessage, Tn as requestHeartbeatNow, Tr as clearAgentRunContext, Ut as detectSuspiciousPatterns, Wt as getHookType, X as getTotalPendingReplies, Y as createReplyDispatcher, Yn as stopSubagentsForRequester, _ as loadOpenClawPlugins, _r as setCommandLaneConcurrency, a as runSubagentAnnounceFlow, an as isGatewaySigusr1RestartExternallyAllowed, ar as resolveTtsConfig, at as createOpenClawTools, b as handleSlackHttpRequest, br as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, bt as consumeRestartSentinel, c as abortEmbeddedPiRun, cn as setGatewaySigusr1RestartPolicy, cr as setTtsEnabled, d as applyToolPolicyPipeline, dn as normalizeGroupActivation, dr as OPENAI_TTS_MODELS, en as applyVerboseOverride, er as getTtsProvider, f as buildDefaultToolPolicyPipelineSteps, fr as OPENAI_TTS_VOICES, gr as resetAllLanes, gt as resetDirectoryCache, h as resolvePluginTools, hr as getTotalQueueSize, in as emitGatewayRestart, ir as resolveTtsAutoMode, it as runCliAgent, j as createDefaultDeps, jn as resolveSendPolicy, jt as normalizeOptionalAgentId, k as resolveAgentOutboundTarget, kr as registerAgentRunContext, kt as normalizeCronJobPatch, l as getActiveEmbeddedRunCount, ln as setPreRestartDeferralCheck, lr as setTtsProvider, lt as ensureOutboundSessionEntry, m as getPluginToolMeta, mt as resolveSessionDeliveryTarget, n as initSubagentRegistry, nn as consumeGatewaySigusr1RestartAuthorization, nr as isTtsProviderConfigured, nt as getCliSessionId, o as clearSessionQueues, on as markGatewaySigusr1RestartHandled, or as resolveTtsPrefsPath, ot as readLatestAssistantReply, pn as loadProviderUsageSummary, pr as getActiveTaskCount, pt as resolveOutboundTarget, qt as persistBrowserProxyFiles, r as listDescendantRunsForRequester, rn as deferGatewayRestartUntilIdle, rr as resolveTtsApiKey, rt as setCliSessionId, s as runEmbeddedPiAgent, sn as scheduleGatewaySigusr1Restart, sr as resolveTtsProviderOrder, st as resolveAnnounceTargetFromKey, t as countActiveDescendantRuns, tn as parseVerboseOverride, tr as isTtsEnabled, tt as resolveCronStyleNow, u as waitForEmbeddedPiRunEnd, un as unbindThreadBindingsBySessionKey, ur as textToSpeech, ut as resolveOutboundSessionRoute, vr as waitForActiveTasks, vt as runWithModelFallback, w as sleepWithAbort, wr as stripHeartbeatToken, wt as summarizeRestartSentinel, x as readJsonBodyWithLimit, xn as enqueueSystemEvent, xt as formatDoctorNonInteractiveHint, yr as CommandLane, zn as resolveInputFileLimits, zt as stripLegacyDeliveryFields } from "./subagent-registry-iN-FM0Uz.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-Dvmk_rXi.js";
import { i as normalizeInputProvenance } from "./input-provenance-C6EIah7A.js";
import "./chat-envelope-BG_U_muK.js";
import { $ as validateNodePairRejectParams, $t as verifyDeviceSignature, A as validateCronStatusParams, At as PROTOCOL_VERSION, B as validateExecApprovalsGetParams, Bt as rejectDevicePairing, C as validateConfigSetParams, Ct as validateWakeParams, D as validateCronRemoveParams, Dt as validateWizardNextParams, E as validateCronListParams, Et as validateWizardCancelParams, F as validateDevicePairRemoveParams, Ft as buildDeviceAuthPayload, G as validateModelsListParams, Gt as summarizeDeviceTokens, H as validateExecApprovalsNodeSetParams, Ht as requestDevicePairing, I as validateDeviceTokenRevokeParams, It as approveDevicePairing, J as validateNodeInvokeParams, Jt as roleScopesAllow, K as validateNodeDescribeParams, Kt as updatePairedDeviceMetadata, L as validateDeviceTokenRotateParams, Lt as ensureDeviceToken, M as validateDevicePairApproveParams, Mt as errorShape, N as validateDevicePairListParams, O as validateCronRunParams, Ot as validateWizardStartParams, P as validateDevicePairRejectParams, Pt as parseSessionLabel, Q as validateNodePairListParams, Qt as normalizeDevicePublicKeyBase64Url, R as validateExecApprovalRequestParams, Rt as getPairedDevice, S as validateConfigSchemaParams, St as validateUpdateRunParams, T as validateCronAddParams, Tt as validateWebLoginWaitParams, U as validateExecApprovalsSetParams, Ut as revokeDeviceToken, V as validateExecApprovalsNodeGetParams, Vt as removePairedDevice, W as validateLogsTailParams, Wt as rotateDeviceToken, X as validateNodeListParams, Xt as deriveDeviceIdFromPublicKey, Y as validateNodeInvokeResultParams, Z as validateNodePairApproveParams, _ as validateChatInjectParams, _t as validateSkillsStatusParams, a as validateAgentWaitParams, at as validateRequestFrame, b as validateConfigGetParams, bt as validateTalkModeParams, c as validateAgentsFilesGetParams, ct as validateSessionsDeleteParams, d as validateAgentsListParams, dt as validateSessionsPreviewParams, et as validateNodePairRequestParams, f as validateAgentsUpdateParams, ft as validateSessionsResetParams, g as validateChatHistoryParams, gt as validateSkillsInstallParams, h as validateChatAbortParams, ht as validateSkillsBinsParams, i as validateAgentParams, it as validatePushTestParams, j as validateCronUpdateParams, jt as ErrorCodes, k as validateCronRunsParams, kt as validateWizardStatusParams, l as validateAgentsFilesListParams, lt as validateSessionsListParams, m as validateChannelsStatusParams, mt as validateSessionsUsageParams, n as formatValidationErrors, nt as validateNodeRenameParams, o as validateAgentsCreateParams, ot as validateSendParams, p as validateChannelsLogoutParams, pt as validateSessionsResolveParams, q as validateNodeEventParams, qt as verifyDeviceToken, r as validateAgentIdentityParams, rt as validatePollParams, s as validateAgentsDeleteParams, st as validateSessionsCompactParams, tt as validateNodePairVerifyParams, u as validateAgentsFilesSetParams, ut as validateSessionsPatchParams, v as validateChatSendParams, vt as validateSkillsUpdateParams, w as validateConnectParams, wt as validateWebLoginStartParams, x as validateConfigPatchParams, xt as validateToolsCatalogParams, y as validateConfigApplyParams, yt as validateTalkConfigParams, z as validateExecApprovalResolveParams, zt as listDevicePairing } from "./client-BtjXMOD6.js";
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-wW8gVtcZ.js";
import { c as readJsonFile, l as writeJsonAtomic, s as createAsyncLock } from "./pairing-token-qLzAsGdq.js";
import { t as safeEqualSecret } from "./secret-equal-DRMKpDYs.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, p as rawDataToString, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-BEAjYacy.js";
import "./ip-m9Sjsn1o.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-BOWO-AaH.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-D60Twogq.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-DMFffs65.js";
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-5phD_2ry.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-J4rp2SRl.js";
import "./diagnostic-session-state-CT36_PCE.js";
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-CPqWCIpr.js";
import { c as detectMime } from "./image-ops-CdtmwUCR.js";
import "./pi-embedded-helpers-exOSg0SH.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-DbkY-n_5.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-BS-Gk_Yg.js";
import "./chrome-C87R1Xsf.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-B21pc9dr.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-Dw00sIWu.js";
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-D3vMUOx2.js";
import { i as compileSafeRegex } from "./redact-CjuqjXFe.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-DjnYuRJy.js";
import { n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-Cwp1VOPx.js";
import { t as movePathToTrash } from "./trash-CX7nB-3e.js";
import { t as SsrFBlockedError } from "./ssrf-BjDQh-0k.js";
import "./store-CP7czNHW.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-CCM0e3iq.js";
import "./server-middleware-ti_BzwRQ.js";
import "./tool-images-DfuwmJ1p.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BF74hBT8.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-CDxxY0BF.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-DAIF-Rwe.js";
import { n as resolveMemorySearchConfig } from "./manager--aJTY1M6.js";
import "./gemini-auth-Bj9G0aYa.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-D9xirO1r.js";
import "./query-expansion-BTx3AUZ-.js";
import "./retry-BLB59C0N.js";
import { a as ToolInputError } from "./target-errors-BxFxCuxQ.js";
...
import { r as isRestartEnabled } from "./commands-DwTwWbLM.js";
import "./commands-registry-BVUPxlFP.js";
import { S as extractTextFromChatContent } from "./image-C6U9TGpS.js";
import "./tool-display-9_qVpbf1.js";
import { d as registerUnhandledRejectionHandler } from "./runner-CM2qQk09.js";
import { n as loadModelCatalog } from "./model-catalog-BORjXO2a.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-DkHgoxfi.js";
import "./fetch-Cg7F6jVj.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-B-M763CP.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-D-n95OK4.js";
...
import { t as formatHelpExamples } from "./help-format-CSCL71i7.js";
import { n as withProgress } from "./progress-NYYdD1uh.js";
import "./replies-CG_wcwKh.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-RAaNUuUn.js";
import "./prompt-style-EoDyMHYF.js";
import "./pairing-labels-BZuavyLB.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-CoDNviq1.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-C9cyOYGd.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Bt9QsA1u.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DeHHq9a4.js";
import { n as inheritOptionFromParent } from "./command-options-DMZnoQOj.js";
import { t as buildChannelUiCatalog } from "./catalog-qxFkHr5X.js";
import { t as WizardCancelledError } from "./prompts-AgMVBh2-.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-CsUUzh6e.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-rBk-gbf-.js";
import { t as isWithinDir } from "./path-safety-C7nDjUF9.js";
import "./install-safe-path-tn5WXukl.js";
import "./skill-scanner-CJA9HQJN.js";
import { t as buildChannelAccountSnapshot } from "./status-B7XwQ8iW.js";
import "./channels-status-issues-CLFu8UWe.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BErSU9Ln.js";
...
import "./lifecycle-core-B2Z0Efkr.js";
import "./systemd-hints-DnmvBkbB.js";
import { t as parsePort$1 } from "./parse-port-e2GZqX81.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-Do6uZCv3.js";
import "./diagnostics-D5olhLC0.js";
import "./table-YCHuxnuC.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BEZPY3Gj.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DLX7e9XC.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-BAhElXTG.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CIYDqO0C.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-B2wKkPUA.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BpzeWhmh.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DbVPPoBH.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-DKs4wEfz.js";
import { t as runOnboardingWizard } from "./onboarding-DhShGt9S.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BLTXEkRf.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DjhnFC6S.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-D6766M8d.js";
import "./dm-policy-shared-DjWlSk9J.js";
import "./node-service-Dh_gDUTx.js";
import "./status.update-DQgC_n0v.js";
import { t as resolveSystemRunCommand } from "./system-run-command-CxIm-8pw.js";
import { t as installSkill } from "./skills-install-Da15Te-3.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-CvUfBuPC.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DaPE6J7_.js";
import { n as forceFreePortAndWait } from "./ports-BtBq1142.js";
...
async function runCronIsolatedAgentTurn(params) {
	...
	if (deliveryResult.result) {
		if (!hasErrorPayload || deliveryResult.result.status !== "ok") return deliveryResult.result;
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DxJYfUzf.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-CvGuEEE6.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-Bj3IsbTK.js");
		...
		try {
			...
			if (!client) {
				...
				const handleMissingDeviceIdentity = () => {
					...
					const trustedProxyAuthOk = isControlUi && resolvedAuth.mode === "trusted-proxy" && authOk && authMethod === "trusted-proxy";
				...
				const skipPairing = shouldSkipControlUiPairing(controlUiAuthPolicy, sharedAuthOk, isControlUi && resolvedAuth.mode === "trusted-proxy" && authOk && authMethod === "trusted-proxy") || skipPairingForOperatorSharedAuth;
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-ChFqRLAV.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-5phD_2ry.js").then((n) => n.n);
