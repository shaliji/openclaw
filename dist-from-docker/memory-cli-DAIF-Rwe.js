...
import { Dt as theme, Et as isRich, Qt as resolveStateDir, Tt as colorize, ct as shortenHomeInString, lt as shortenHomePath, ot as resolveUserPath, s as createSubsystemLogger, v as defaultRuntime, xt as setVerbose } from "./entry.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-BWoB6KB9.js";
import { T as parseDurationMs, i as loadConfig, mt as splitShellArgs } from "./config-LXNfmZdV.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-BTx3AUZ-.js";
import { t as formatDocsLink } from "./links-DNSoSnpZ.js";
import { r as withManager } from "./cli-utils-DyGKoc5l.js";
import { t as formatHelpExamples } from "./help-format-CSCL71i7.js";
import { n as withProgress, r as withProgressTotals } from "./progress-NYYdD1uh.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-Tz3vwFee.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager--aJTY1M6.js").then((n) => n.t);
