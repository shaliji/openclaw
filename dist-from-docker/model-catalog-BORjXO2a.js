...
import { E as resolveOpenClawAgentDir } from "./auth-profiles-vU5h6gxf.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CwESh4K1.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Bx9J7ee7.js").then((n) => n.n)).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
