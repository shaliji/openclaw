...
import { zt as resolveOpenClawAgentDir } from "./model-selection-CWlCAKYd.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-Bakt-Qrp.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-C513HytN.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
