...
import { Dt as theme, Et as isRich$1, Lt as CONFIG_PATH, Tt as colorize, lt as shortenHomePath } from "./entry.js";
import { B as parseModelRef, Ct as getCustomProviderApiKey, Dt as resolveEnvApiKey, E as resolveOpenClawAgentDir, Et as resolveAwsSdkEnvVarName, It as shouldEnableShellEnvFallback, Jt as DEFAULT_MODEL, K as resolveModelRefFromString, L as modelKey, M as buildModelAliasIndex, N as findNormalizedProviderValue, T as resolveAuthStorePathForDisplay, Tt as resolveApiKeyForProvider, U as resolveConfiguredModelRef, W as resolveDefaultModelForAgent, Xt as resolveAuthProfileDisplayLabel, Yt as DEFAULT_PROVIDER, g as listProfilesForProvider, jt as getShellEnvAppliedKeys, n as resolveAuthProfileOrder, s as resolveProfileUnusableUntilForDisplay, v as setAuthProfileOrder, x as ensureAuthProfileStore, y as upsertAuthProfile, z as normalizeProviderId } from "./auth-profiles-vU5h6gxf.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-BWoB6KB9.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-Bx9J7ee7.js";
import { r as resolveForwardCompatModel } from "./model-Csk0ByVm.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { T as parseDurationMs, i as loadConfig } from "./config-LXNfmZdV.js";
import { Qt as formatRemainingShort, Xt as DEFAULT_OAUTH_WARN_MS, Yt as maskApiKey, Zt as buildAuthHealthSummary, gn as resolveUsageProviderId, hn as formatUsageWindowSummary, pn as loadProviderUsageSummary, s as runEmbeddedPiAgent, yt as describeFailoverError } from "./subagent-registry-iN-FM0Uz.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-Dvmk_rXi.js";
import { t as ensureOpenClawModelsJson } from "./models-config-gjIj_GyC.js";
import { n as loadModelCatalog } from "./model-catalog-BORjXO2a.js";
import { r as withProgressTotals } from "./progress-NYYdD1uh.js";
import { f as openUrl } from "./onboard-helpers-RAaNUuUn.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-EoDyMHYF.js";
import { t as createClackPrompter } from "./clack-prompter-DbBu50V1.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-D-fLerqx.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-2VDaF_T2.js";
import { n as logConfigUpdated } from "./logging-2pVgGvge.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-B64o9a_P.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-LXNfmZdV.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./auth-profiles-vU5h6gxf.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-Csk0ByVm.js").then((n) => n.t);
