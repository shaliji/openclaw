...
import { T as parseDurationMs, i as loadConfig } from "./config-D8wVkXOO.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DI5fQaUg.js";
...
import { r as resolveForwardCompatModel } from "./model-X_1vSk9O.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-BLyYBkBV.js";
...
import { r as withProgressTotals } from "./progress-CzLXOXj6.js";
...
import { f as openUrl } from "./onboard-helpers-D8SqiGEU.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-B9CxJ3jd.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Cg-LZrY-.js";
import { n as logConfigUpdated } from "./logging-CPXozfuk.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-bY9EPZX6.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-D8wVkXOO.js").then((n) => n.t);
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BLyYBkBV.js");
