import { Kt as resolveGatewayPort, ot as resolveUserPath, v as defaultRuntime, y as restoreTerminalState } from "./entry.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-RAaNUuUn.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-CCAFL3ar.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-C8xMZh8c.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DD_c6f7k.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Ci-J7Vw6.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BpzeWhmh.js").then((n) => n.i);
