...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-C5Sd3JES.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-D8wVkXOO.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-D8SqiGEU.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BHPM2ZRi.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-BF69U3yL.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C9-Kv6-h.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CSNNf8Cl.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BnK25Q16.js").then((n) => n.i);
