import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-Hfb1XxZc.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-BY8fKpqm.js";
import { L as resolveUserPath, W as truncateUtf16Safe, ct as resolvePreferredOpenClawTmpDir, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger } from "./subsystem-Ck26JAQG.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-YGVrIVO5.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-BlZ2KU7g.js";
import { t as generateSecureToken } from "./secure-random-D7Pne8Yn.js";
import { c as SafeOpenError, i as getImageMetadata, l as openFileWithinRoot, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BMu2pljU.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-iMXuX63S.js";
...
import { t as SsrFBlockedError } from "./ssrf-B7akL5oa.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DLU3Jlvr.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-B5JHXmzV.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DPA8_FS3.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-CqgAJQgf.js";
import { B as canonicalizeMainSessionAlias, K as acquireSessionWriteLock, V as resolveAgentMainSessionKey } from "./sessions-ROkwCDZM.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DHyP4K9M.js";
import { o as normalizeThinkLevel } from "./thinking-ZaPrKXBc.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DgZd7bgu.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DgZd7bgu.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { mergeAlsoAllowPolicy as $, isTransientHttpError as A, resolveProfile as B, isContextOverflowError as C, isRateLimitAssistantError as D, isLikelyContextOverflowError as E, resolveSandboxContext as F, resolveBrowserControlAuth as G, resolveExistingPathsWithinRoot as H, resolveSandboxRuntimeStatus as I, resolveSandboxConfigForAgent as J, resolveGatewayCredentialsFromConfig as K, createBrowserRouteContext as L, parseImageSizeError as M, sanitizeUserFacingText as N, isRawApiErrorPayload as O, ensureSandboxWorkspaceForSession as P, expandPolicyWithPluginGroups as Q, registerBrowserRoutes as R, isCompactionFailureError as S, isFailoverErrorMessage as T, getBridgeAuthForPort as U, DEFAULT_UPLOAD_DIR as V, ensureBrowserControlAuth as W, buildPluginToolGroups as X, applyOwnerOnlyToolPolicy as Y, collectExplicitAllowlist as Z, formatRawAssistantErrorForUi as _, isMessagingToolDuplicateNormalized as a, matchesAnyGlobPattern as at, isBillingAssistantError as b, extractToolCallsFromAssistant as c, resolveBootstrapMaxChars as ct, downgradeOpenAIReasoningBlocks as d, stripPluginOnlyAllowlist as et, isGoogleModelApi as f, formatBillingErrorMessage as g, formatAssistantErrorText as h, isMessagingToolDuplicate as i, compileGlobPatterns as it, parseImageDimensionError as j, isTimeoutErrorMessage as k, extractToolResultId as l, resolveBootstrapTotalMaxChars as lt, classifyFailoverReason as m, validateGeminiTurns as n, normalizeToolName as nt, normalizeTextForComparison as o, buildBootstrapContextFiles as ot, BILLING_ERROR_USER_MESSAGE as p, trimToUndefined as q, pickFallbackThinkingLevel as r, resolveToolProfilePolicy as rt, sanitizeSessionMessagesImages as s, ensureSessionHeader as st, validateAnthropicTurns as t, expandToolGroups as tt, sanitizeToolCallIdsForCloudCodeAssist as u, sanitizeGoogleTurnOrdering as ut, getApiErrorPayloadFingerprint as v, isFailoverAssistantError as w, isCloudCodeAssistFormatError as x, isAuthAssistantError as y, resolveBrowserConfig as z };