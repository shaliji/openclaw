...
import { f as readWebSelfId, o as getWebAuthAgeMs, r as resolveWhatsAppAccount } from "./accounts-nRb69JLQ.js";
import { C as formatDurationPrecise, Ct as resolveDefaultGroupPolicy, Et as warnMissingProviderGroupPolicyFallbackOnce, H as shouldAckReactionForWhatsApp, J as buildHistoryContextFromEntries, U as resolveMentionGating, _t as resolveEnvelopeFormatOptions, c as computeBackoff, d as dispatchReplyWithBufferedBlockDispatcher, dt as createDedupeCache, et as recordPendingHistoryEntryIfEnabled, g as shouldComputeCommandAuthorized, h as hasControlCommand, ht as formatInboundEnvelope, l as sleepWithAbort, m as resolveInboundDebounceMs, n as normalizeGroupActivation, nt as normalizeMentionText, p as createInboundDebouncer, q as DEFAULT_GROUP_HISTORY_LIMIT, r as parseActivationCommand, t as getReplyFromConfig, tt as buildMentionRegexes, u as buildPairingReply, w as enqueueSystemEvent, wt as resolveOpenProviderRuntimeGroupPolicy } from "./reply-DJot6AxU.js";
import { D as clamp, F as jidToE164, I as normalizeE164, K as toWhatsappJid, P as isSelfChatMode, W as sleep, Z as logVerbose, et as shouldLogVerbose, i as defaultRuntime, ot as getChildLogger, p as normalizeChatChannelId, t as createSubsystemLogger, z as resolveJidToE164 } from "./subsystem-D1LlWNKh.js";
import { n as loadConfig } from "./config-b1GE10z7.js";
import { t as formatCliCommand } from "./command-format-DoSIFR_b.js";
import { M as resolveChannelGroupRequireMention, j as resolveChannelGroupPolicy } from "./dock-CQy_H_Rg.js";
import { n as recordChannelActivity } from "./channel-activity-B9d5ny6b.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-D_P4PWjD.js";
import { a as loadWebMedia } from "./ir-Bv4SEXx8.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode, l as resolveTextChunkLimit } from "./chunk-lbYIkQbr.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-BS0IHHiP.js";
import { t as convertMarkdownTables } from "./tables-Dh3DNgx4.js";
import { $ as upsertChannelPairingRequest, X as readChannelAllowFromStore, Z as readChannelAllowFromStoreSync, nt as formatLocationText, rt as toLocationContext } from "./send-Ckp9TobS.js";
import { f as registerUnhandledRejectionHandler } from "./runner-fuad4tp5.js";
import { l as resolveIdentityNamePrefix, n as createReplyPrefixOptions, u as resolveMessagePrefix } from "./reply-prefix-BWJ9RKXw.js";
import { K as resolveGroupSessionKey, c as readSessionUpdatedAt, l as recordSessionMetaFromInbound, s as loadSessionStore, u as updateLastRoute } from "./sessions-BBcAttd6.js";
import { l as resolveStorePath } from "./paths-B-NY-HdV.js";
import { i as saveMediaBuffer } from "./store-QhgTD87A.js";
import { t as finalizeInboundContext } from "./inbound-context-DAG51Tji.js";
import { n as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-ExuyCx1l.js";
import { r as setActiveWebListener } from "./active-listener-DuxBmVCE.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-DCcP9Ag3.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-CI2FnN6i.js";
