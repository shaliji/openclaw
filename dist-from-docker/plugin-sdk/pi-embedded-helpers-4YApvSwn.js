...
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-DVWx7USN.js";
import { B as resolveUserPath, c as CHANNEL_IDS, ft as resolvePreferredOpenClawTmpDir, i as defaultRuntime, q as truncateUtf16Safe, t as createSubsystemLogger } from "./subsystem-D1LlWNKh.js";
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-b1GE10z7.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-DoSIFR_b.js";
import { D as runExec, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-BNHH2QOv.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DxNipVio.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-CmUQkJk5.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-sfFEhh57.js";
import { t as SsrFBlockedError } from "./ssrf-CnX37IfG.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-tydwRamF.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-Cc6Zi6ij.js";
import { A as DEFAULT_OPENCLAW_BROWSER_ENABLED, C as stopChromeExtensionRelayServer, D as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, E as DEFAULT_AI_SNAPSHOT_MAX_CHARS, M as isLoopbackHost, O as DEFAULT_BROWSER_EVALUATE_ENABLED, S as ensureChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, y as fetchOk } from "./chrome-Bf_EB-XC.js";
import { A as acquireSessionWriteLock, H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias } from "./sessions-BBcAttd6.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-QhgTD87A.js";
import { o as normalizeThinkLevel } from "./thinking-BpFZfHN9.js";
import { t as generateSecureToken } from "./secure-random-CV-D0cj2.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CXFKmihI.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CXFKmihI.js")).closePlaywrightBrowserConnection();
		} catch {}
...
var SandboxFsBridgeImpl = class {
	...
	async resolveCanonicalContainerPath(params) {
		...
		const canonical = (await this.runCommand(script, { args: [params.containerPath, params.allowFinalSymlink ? "1" : "0"] })).stdout.toString("utf8").trim();
...
async function assertNoHostSymlinkEscape(params) {
	...
	if (!isPathInside(root, target)) throw new Error(`Sandbox path escapes mount root (${root}): ${params.absolutePath}`);
	...
	for (let idx = 0; idx < parts.length; idx += 1) {
		...
		try {
			...
			if (params.allowFinalSymlink && isLast) return;
			const symlinkTarget = await tryRealpath(current);
			if (!isPathInside(rootReal, symlinkTarget)) throw new Error(`Symlink escapes sandbox mount root (${rootReal}): ${current}`);
...
//#endregion
export { expandToolGroups as $, isTransientHttpError as A, resolveProfile as B, isContextOverflowError as C, isRateLimitAssistantError as D, isLikelyContextOverflowError as E, resolveSandboxContext as F, resolveBrowserControlAuth as G, resolveExistingPathsWithinRoot as H, resolveSandboxRuntimeStatus as I, buildPluginToolGroups as J, resolveSandboxConfigForAgent as K, createBrowserRouteContext as L, parseImageSizeError as M, sanitizeUserFacingText as N, isRawApiErrorPayload as O, ensureSandboxWorkspaceForSession as P, stripPluginOnlyAllowlist as Q, registerBrowserRoutes as R, isCompactionFailureError as S, isFailoverErrorMessage as T, getBridgeAuthForPort as U, DEFAULT_UPLOAD_DIR as V, ensureBrowserControlAuth as W, expandPolicyWithPluginGroups as X, collectExplicitAllowlist as Y, mergeAlsoAllowPolicy as Z, formatRawAssistantErrorForUi as _, isMessagingToolDuplicateNormalized as a, ensureSessionHeader as at, isBillingAssistantError as b, extractToolCallsFromAssistant as c, sanitizeGoogleTurnOrdering as ct, downgradeOpenAIReasoningBlocks as d, normalizeToolName as et, isGoogleModelApi as f, formatBillingErrorMessage as g, formatAssistantErrorText as h, isMessagingToolDuplicate as i, buildBootstrapContextFiles as it, parseImageDimensionError as j, isTimeoutErrorMessage as k, extractToolResultId as l, resolveGatewayCredentialsFromConfig as lt, classifyFailoverReason as m, validateGeminiTurns as n, compileGlobPatterns as nt, normalizeTextForComparison as o, resolveBootstrapMaxChars as ot, BILLING_ERROR_USER_MESSAGE as p, applyOwnerOnlyToolPolicy as q, pickFallbackThinkingLevel as r, matchesAnyGlobPattern as rt, sanitizeSessionMessagesImages as s, resolveBootstrapTotalMaxChars as st, validateAnthropicTurns as t, resolveToolProfilePolicy as tt, sanitizeToolCallIdsForCloudCodeAssist as u, trimToUndefined as ut, getApiErrorPayloadFingerprint as v, isFailoverAssistantError as w, isCloudCodeAssistFormatError as x, isAuthAssistantError as y, resolveBrowserConfig as z };