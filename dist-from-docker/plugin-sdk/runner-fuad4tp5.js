import { n as fetchWithTimeout } from "./fetch-timeout-D14QGlq9.js";
import { Z as logVerbose, et as shouldLogVerbose, ft as resolvePreferredOpenClawTmpDir, t as createSubsystemLogger } from "./subsystem-D1LlWNKh.js";
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-b1GE10z7.js";
import { E as resolveApiKeyForProvider, H as resolveOpenClawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-KxC5cuqU.js";
import { D as runExec, F as resolveAgentModelPrimaryValue, P as resolveAgentModelFallbackValues } from "./agent-scope-BNHH2QOv.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CmUQkJk5.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CMFgPVHO.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-D_P4PWjD.js";
import { t as normalizeChatType } from "./chat-type-nF1vanR8.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BeqE3a3I.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CNP1dAqt.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BbZDWDzI.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
