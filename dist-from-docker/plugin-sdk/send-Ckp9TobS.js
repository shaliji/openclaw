...
import { a as resolveOAuthDir, c as expandHomePrefix, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-DVWx7USN.js";
import { S as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-C_oazOl4.js";
import { t as resolveFetch } from "./fetch-DdmiNDLY.js";
import { E as CONFIG_DIR, V as safeParseJson, Y as danger, Z as logVerbose, t as createSubsystemLogger } from "./subsystem-D1LlWNKh.js";
import { i as readConfigFileSnapshotForWrite, kt as resolveTelegramPreviewStreamMode, n as loadConfig, o as writeConfigFile } from "./config-b1GE10z7.js";
import { r as isTruthyEnvValue } from "./command-format-DoSIFR_b.js";
import { W as withFileLock$1 } from "./model-selection-KxC5cuqU.js";
import { t as redactSensitiveText } from "./redact-CamFT8Bc.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-DxNipVio.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-B9d5ny6b.js";
import { n as normalizePollInput } from "./polls-BVXGH_xL.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-CmUQkJk5.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-Bv4SEXx8.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-BS0IHHiP.js";
import { t as renderMarkdownWithMarkers } from "./render-3_VJ30aR.js";
...
function readAllowFromStateForPathSync(channel, filePath) {
	try {
		...
		return normalizeAllowFromList(channel, JSON.parse(raw));
	} catch {
		return [];
	}
}
...
function readChannelAllowFromStoreSync(channel, env = process.env, accountId) {
	if (!(accountId?.trim().toLowerCase() ?? "")) return readAllowFromStateForPathSync(channel, resolveAllowFromPath(channel, env));
...
//#endregion
export { upsertChannelPairingRequest as $, hasBotMention as A, resolveSenderAllowMatch as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramReplyId as F, isVoiceCompatibleAudio as G, isSenderIdAllowed as H, resolveTelegramStreamMode as I, resolveTelegramTargetChatType as J, normalizeTelegramLookupTarget as K, resolveTelegramThreadSpec as L, resolveTelegramForumThreadId as M, resolveTelegramGroupAllowFromContext as N, expandTextLinks as O, resolveTelegramMediaPlaceholder as P, removeChannelAllowFromStoreEntry as Q, isSenderAllowed as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, mergeAllowFromSources as U, firstDefined as V, withTelegramApiErrorLogging as W, readChannelAllowFromStore as X, addChannelAllowFromStoreEntry as Y, readChannelAllowFromStoreSync as Z, resolveTelegramFetch as _, reactMessageTelegram as a, isWSLEnv as at, buildSenderLabel as b, sendStickerTelegram as c, writeJsonFileAtomically as ct, wasSentByBot as d, getPairingAdapter as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, isWSL2Sync as it, normalizeForwardedContext as j, extractTelegramLocation as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, formatLocationText as nt, sendMessageTelegram as o, isWSLSync as ot, markdownToTelegramChunks as p, parseTelegramTarget as q, deleteMessageTelegram as r, toLocationContext as rt, sendPollTelegram as s, readJsonFileWithFallback as st, buildInlineKeyboard as t, listPairingChannels as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, normalizeAllowFromWithStore as z };