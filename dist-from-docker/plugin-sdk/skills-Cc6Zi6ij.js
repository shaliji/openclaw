import { B as resolveUserPath, E as CONFIG_DIR, ft as resolvePreferredOpenClawTmpDir, t as createSubsystemLogger } from "./subsystem-D1LlWNKh.js";
import { i as parseBooleanValue } from "./command-format-DoSIFR_b.js";
import { it as isDangerousHostEnvVarName } from "./model-selection-KxC5cuqU.js";
import { N as normalizeSkillFilter, T as resolveOpenClawPackageRootSync } from "./agent-scope-BNHH2QOv.js";
import { a as LEGACY_MANIFEST_KEYS, c as normalizePluginsConfig, l as resolveEffectiveEnableState, o as MANIFEST_KEY, t as loadPluginManifestRegistry, u as resolveMemorySlotDecision } from "./manifest-registry-Ctatc67v.js";
...
async function assertNoHardlinkedFinalPath(filePath, tmpRoot) {
	let stat;
	try {
	...
	if (stat.nlink > 1) throw new Error(`Hardlinked tmp media path is not allowed under tmp root (${shortPath(tmpRoot)}): ${shortPath(filePath)}`);
}
