...
import { o as hasHelpOrVersion, r as getPrimaryCommand, t as buildParseArgv } from "./argv-K2xNvkeC.js";
import { r as resolveActionArgs } from "./helpers-bQ13GLov.js";
...
const loadConfig = async () => {
	return (await import("./config-D8wVkXOO.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-8zUV3dZT.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-DJjRroKp.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./daemon-cli-C6lr0INf.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-D7hHeHZE.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./system-cli-DjdH6mMl.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-Psif0Vp7.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./exec-approvals-cli-CSa-rvuP.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./nodes-cli-Si7bKbyT.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./devices-cli-D07Uwwrn.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-3Vorh5bz.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-CHKC05OC.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-CASGyf1l.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./cron-cli-Cjm4PHuc.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./dns-cli-Dcu6Vjwl.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./docs-cli-CpPnvu4P.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-Bg1lDS3H.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./webhooks-cli-BjW_mMis.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "qr",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-Bd-6uYpe.js").then((n) => n.t)).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-BASoEeMT.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-CdTt00yF.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-Bl5UJhlG.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-C54xf0Nv.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-CdTt00yF.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-BlzYUyD9.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-BRHRfsnG.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-DkNlZOTR.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./skills-cli-prE_7qls.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-uPXwaVIe.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-DDDCtPkn.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-DwppF63F.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DTxD9GSa.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-CWMWscZl.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-Bgj-WXH4.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-Bbq9EUQE.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-CbK07KHe.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-f6o2IVjT.js").then((n) => n.t)).registerMemoryCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-DLm9UMT6.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-rJwnqu1r.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./browser-cli-tcWk0BT-.js")).registerBrowserCli(program);
		}
	}
];
