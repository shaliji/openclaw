import { At as getResolvedLoggerSettings, Kt as resolveGatewayPort, Lt as CONFIG_PATH, Qt as resolveStateDir, Xt as resolveOAuthDir, gn as resolveRequiredHomeDir, lt as shortenHomePath, ot as resolveUserPath, qt as resolveIsNixMode, r as isTruthyEnvValue, ut as sleep, v as defaultRuntime } from "./entry.js";
...
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-BWoB6KB9.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BWKDUbl-.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-G9-WTRVN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BN0uSo-W.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-LXNfmZdV.js";
import { B as cleanStaleLockFiles, at as isPrimarySessionTranscriptFileName, c as loadSessionStore, et as resolveMainSessionKey, it as formatSessionArchiveTimestamp } from "./sessions-YJLT80__.js";
import { n as listChannelPlugins } from "./plugins-B-4EYGZt.js";
import { Qt as formatRemainingShort, Xt as DEFAULT_OAUTH_WARN_MS, Zt as buildAuthHealthSummary, _ as loadOpenClawPlugins } from "./subagent-registry-iN-FM0Uz.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-Dvmk_rXi.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-wW8gVtcZ.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-BEAjYacy.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-DbkY-n_5.js";
import { a as resolveGatewayAuth } from "./auth-Dw00sIWu.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-CCM0e3iq.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-DAIF-Rwe.js";
import { n as resolveMemorySearchConfig } from "./manager--aJTY1M6.js";
import { n as loadModelCatalog } from "./model-catalog-BORjXO2a.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-B6D1y3V2.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-B8MZvhl8.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-RAaNUuUn.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-EoDyMHYF.js";
import { t as note$1 } from "./note-BvX_qH_V.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CLFu8UWe.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-BCqguIM6.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DpZTTZBG.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-DefOHKNF.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-XzmwsFMX.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-DnmvBkbB.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-D5olhLC0.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-Bx7aZLM5.js";
import { r as healthCommand } from "./health-BpzeWhmh.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-DbVPPoBH.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DKs4wEfz.js";
import { t as resolveDmAllowState } from "./dm-policy-shared-DjWlSk9J.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-CvUfBuPC.js";
import { n as logConfigUpdated } from "./logging-2pVgGvge.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-sBJ_FcBc.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CeT1Tn2Z.js";
import { t as formatHealthCheckFailure } from "./health-format-DSe8qb0S.js";
import { n as doctorShellCompletion } from "./doctor-completion-D3JsUXgW.js";
