import { C as CHANNEL_IDS, ot as resolveUserPath, s as createSubsystemLogger, v as defaultRuntime, zt as STATE_DIR } from "./entry.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, T as DEFAULT_USER_FILENAME, _ as DEFAULT_AGENT_WORKSPACE_DIR, b as DEFAULT_IDENTITY_FILENAME, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, m as resolveSessionAgentId, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-BWoB6KB9.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-DIABCrXz.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, g as sanitizeEnvVars, o as syncSkillsToWorkspace } from "./skills-CWeJXlIQ.js";
import { n as isPathInside, t as isNotFoundPathError } from "./path-guards-CGCPSXzR.js";
import { S as getBlockedNetworkModeReason, i as loadConfig } from "./config-LXNfmZdV.js";
import { Q as resolveAgentMainSessionKey, Z as canonicalizeMainSessionAlias, z as acquireSessionWriteLock } from "./sessions-YJLT80__.js";
import { r as isLoopbackHost } from "./net-BEAjYacy.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-BS-Gk_Yg.js";
import { O as DEFAULT_BROWSER_EVALUATE_ENABLED, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-C87R1Xsf.js";
import { a as resolveProfile, o as ensureBrowserControlAuth, r as registerBrowserRoutes, s as resolveBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-D3vMUOx2.js";
