...
import { a as resolveOAuthDir, c as expandHomePrefix, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-C9do7WCN.js";
import { C as CONFIG_DIR, J as logVerbose, K as danger, R as safeParseJson, t as createSubsystemLogger } from "./subsystem-OjJSGqSf.js";
import { Z as withFileLock$1 } from "./model-selection-BBnmA-Of.js";
import { t as isTruthyEnvValue } from "./env-1KrR5vLt.js";
import { l as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-CNLxCJ1d.js";
import { g as isGifMedia, p as getFileExtension, v as normalizeMimeType, x as mediaKindFromMime } from "./image-ops-DPerqzPA.js";
import { i as readConfigFileSnapshotForWrite, n as loadConfig, o as writeConfigFile, st as resolveTelegramPreviewStreamMode } from "./config-CjZeYRah.js";
import { t as redactSensitiveText } from "./redact-DMW6QgGu.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-DIsGKZHp.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-bWNZ-uiL.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-BG5AdJZ8.js";
import { t as renderMarkdownWithMarkers } from "./render-loap2gRq.js";
import { t as resolveFetch } from "./fetch-B1nZSYJF.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BhCtwPtR.js";
import { n as normalizePollInput } from "./polls-DXd67TD8.js";
import { t as makeProxyFetch } from "./proxy-Bee2aKQk.js";
...
//#endregion
export { getPairingAdapter as $, extractTelegramLocation as A, normalizeAllowFromWithStore as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramMediaPlaceholder as F, formatLocationText as G, firstDefined as H, resolveTelegramReplyId as I, readChannelAllowFromStore as J, toLocationContext as K, resolveTelegramStreamMode as L, normalizeForwardedContext as M, resolveTelegramForumThreadId as N, describeReplyTarget as O, resolveTelegramGroupAllowFromContext as P, writeJsonFileAtomically as Q, resolveTelegramThreadSpec as R, buildSenderName as S, buildTelegramParentPeer as T, isSenderIdAllowed as U, resolveSenderAllowMatch as V, mergeAllowFromSources as W, upsertChannelPairingRequest as X, removeChannelAllowFromStoreEntry as Y, readJsonFileWithFallback as Z, resolveTelegramFetch as _, reactMessageTelegram as a, buildGroupLabel as b, sendStickerTelegram as c, wasSentByBot as d, listPairingChannels as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, hasBotMention as j, expandTextLinks as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, parseTelegramTarget as nt, sendMessageTelegram as o, markdownToTelegramChunks as p, addChannelAllowFromStoreEntry as q, deleteMessageTelegram as r, resolveTelegramTargetChatType as rt, sendPollTelegram as s, buildInlineKeyboard as t, isVoiceCompatibleAudio as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, withTelegramApiErrorLogging as y, isSenderAllowed as z };