import { Qt as resolveStateDir } from "./entry.js";
import { B as parseModelRef, E as resolveOpenClawAgentDir, F as inferUniqueProviderFromConfiguredModels, Jt as DEFAULT_MODEL, U as resolveConfiguredModelRef, W as resolveDefaultModelForAgent, Yt as DEFAULT_PROVIDER, qt as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-vU5h6gxf.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-BWoB6KB9.js";
import { c as normalizeMainKey, s as normalizeAgentId, w as parseAgentSessionKey, x as isCronRunSessionKey } from "./session-key-DIABCrXz.js";
import { D as AVATAR_MAX_BYTES, F as resolveAvatarMime, N as isWorkspaceRelativeAvatarPath, O as isAvatarDataUrl, i as loadConfig, j as isPathWithinRoot, k as isAvatarHttpUrl } from "./config-LXNfmZdV.js";
import { M as readSessionTitleFieldsFromTranscript, Q as resolveAgentMainSessionKey, Y as resolveFreshSessionTotalTokens, Z as canonicalizeMainSessionAlias, c as loadSessionStore, et as resolveMainSessionKey, ot as buildGroupDisplayName, w as normalizeSessionDeliveryFields } from "./sessions-YJLT80__.js";
import { l as resolveStorePath } from "./paths-Dvmk_rXi.js";
import { t as sameFileIdentity$1 } from "./file-identity-Dol1fVGV.js";
...
(async () => {
	...
	try {
		const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-CwESh4K1.js").then((n) => n.r);
